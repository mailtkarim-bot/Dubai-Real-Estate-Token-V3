import { Building2, Shield, Coins, Globe } from 'lucide-react';
  ...
  return (
    <div className="space-y-16 py-8">
      ...
      <section className="text-center space-y-6">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-gold-300">
          Dubai Real Estate
          <br />
      ...
      <section className="space-y-8">
        <h2 className="text-3xl font-bold text-center text-gold-300">Key Features</h2>
      ...
      <section className="card">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={c.addr} className="flex items-center justify-between bg-dark-700 rounded-lg px-4 py-3">
